...
public final class ViewGroups {
    ...
    public static ViewGroup recipes(ItemLike item) {
        ...
        return new ViewGroup() {
            @Override public Tag getTag() { return Tag.CRAFT; }
            @Override public ItemStack recipeTarget() { return target; }
    ...
    public static ViewGroup displayIcon(String tex, double dx, double dy, double scale, Color color) {
        final ResourceLocation res = Resources.getTexture(tex);
        return new ViewGroup() {
            @Override public Tag getTag() { return Tag.VIEW; }
            @Override public ResourceLocation previewIcon() { return res; }
        };
    }
    ...
    private static ViewGroup itemView(ItemStack stack, Tag tag) {
        return new ViewGroup() {
            ...
            @Override public ItemStack previewStack() { return stack; }
            @Override public String getDisplayText() { return stack.getHoverName().getString(); }
        };
    }
